...
{
    partial class DataForm : DockContent
    {
        public DataForm()
        {
            InitializeComponent();
        ...
        private void mHex_SelectionLengthChanged(object pSender, EventArgs pArgs)
        {
            ...
            else
            {
                ...
                if (buffer != null) MainForm.PropertyForm.Properties.SelectedObject = new StructureSegment(buffer, (int)mHex.SelectionStart, (int)mHex.SelectionLength, 0);
