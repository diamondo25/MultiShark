...
{
    partial class StructureForm : DockContent
    {
        private IBasePacket<IBaseOpcode> mParsing = null;
        ...
        private void mTree_AfterSelect(object pSender, TreeViewEventArgs pArgs)
        {
            ...
            MainForm.PropertyForm.Properties.SelectedObject = new StructureSegment(node.Buffer, node.Cursor, node.Length, 0);
        }
